...
|-------|----------|----------|
| **Discovery** | What can this host do? | [capabilities.txt](https://capabilityhostprotocol.com/capabilities-txt) |
| **Invocation** | How do I call it? | MCP (and HTTP, SDKs) |
| **Evidence** | What happened, and can I prove it? | CHP |
