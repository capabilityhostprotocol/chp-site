...
const requiredText = {
  ...
  '/docs/reference/manifest-fields': ['Manifest fields', 'capabilities[].policy.state', 'Developer reference'],
  '/docs/reference/invocation-envelope': ['Invocation envelope fields', 'correlation_id', 'timeout_ms'],
  '/docs/reference/outcome-codes': ['Outcome codes', 'unsupported_protocol_version', 'host_error'],
  '/docs/reference/evidence-events': ['Evidence event fields', 'evidence_type', 'execution_denied'],
  '/docs/reference/conformance-cases': ['Conformance cases', 'authorization_denial', 'permission_denied'],
  '/docs/reference/glossary': ['Glossary', 'Canonical terms', 'Capability'],
  '/docs/reference/failure-modes/unavailable-capability': ['Unavailable capability', 'unavailable_capability', 'execution_denied'],
  '/docs/reference/failure-modes/unknown-host': ['Unknown host', 'unknown_host', 'no trusted manifest'],
  '/docs/reference/failure-modes/malformed-input': ['Malformed input', 'malformed_input', 'Invocation envelope is missing caller'],
  '/docs/reference/failure-modes/version-mismatch': ['Version mismatch', 'unsupported_protocol_version', 'caller requested 0.2'],
  '/docs/reference/failure-modes/authorization-denial': ['Authorization denial', 'permission_denied', 'service:dispatch is required'],
  '/docs/reference/failure-modes/timeout': ['Timeout', 'timeout_ms', 'execution_failed'],
