...
const routes = [
  ...
  '/docs/reference/product-surfaces',
...
const requiredText = {
  ...
  '/adapters': ['Governed adapters', 'pip install chp-adapter-', 'Build your own adapter'],
  ...
  '/docs/reference/product-surfaces': ['Product surface components', 'CapabilityRegistryRow', 'Access matrix'],
