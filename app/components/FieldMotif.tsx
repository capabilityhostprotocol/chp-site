...
/**
 * FieldMotif — the signature visual: actor "actions" drift in from the field
 * and resolve onto a single horizontal evidence trace (many actions, one
 * provable record). Calm motion; honours prefers-reduced-motion by rendering
