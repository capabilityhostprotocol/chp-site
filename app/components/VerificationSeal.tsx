...
export default function VerificationSeal({
  ...
  return (
    ...
    >
      ...
      <dl className="mt-4 grid gap-3 border-t border-[color:var(--color-border-subtle)] pt-4 font-mono text-[11px] text-zinc-400 sm:grid-cols-3">
        <div>
          <dt className="uppercase text-zinc-500">Evidence</dt>
          <dd className="mt-1 text-zinc-300">{evidenceCount} events</dd>
        </div>
        <div>
          <dt className="uppercase text-zinc-500">Case</dt>
