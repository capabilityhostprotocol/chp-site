    ...
    <>
      ...
      <section className="max-w-5xl mx-auto px-6 py-14 border-t border-zinc-800/60">
          ...
          <table className="w-full text-sm text-zinc-400 border-collapse">
            <thead>
              <tr className="border-b border-zinc-800">
                <th className="text-left font-mono text-xs text-zinc-600 uppercase tracking-widest pb-3 pr-6">
                  Question
                </th>
                <th className="text-left font-mono text-xs text-zinc-600 uppercase tracking-widest pb-3 pr-6">
                  Logs
                ...
                <th className="text-left font-mono text-xs text-zinc-600 uppercase tracking-widest pb-3">
                  CHP
                </th>
              </tr>
            </thead>
        ...
        <p className="text-xs text-zinc-600 mt-4">
          ...
          <code className="font-mono text-zinc-500">evidence_to_otel_span()</code>. Export full
          session traces via{' '}
          <code className="font-mono text-zinc-500">replay_to_otel_spans()</code>. See{' '}
          <a
        ...
        <p className="text-xs text-zinc-600 mt-2">
          <code className="font-mono text-zinc-500">aggregate_session_metrics()</code> and{' '}
          <code className="font-mono text-zinc-500">format_prometheus()</code> expose
          session-level metrics in Prometheus text format.{' '}
          <code className="font-mono text-zinc-500">assess_maturity()</code> returns a{' '}
          <code className="font-mono text-zinc-500">MaturityAssessment</code> for self-hosted
          certification.
        </p>
      </section>
